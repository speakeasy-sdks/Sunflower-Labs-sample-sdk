...
class Hive:
    ...
    def hive_roof_control(self, request: operations.HiveRoofControlRequest) -> operations.HiveRoofControlResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='hiveRoofControl', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.HiveRoofControlRequest, "request_body", False, True, 'json')
        ...
        res = operations.HiveRoofControlResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def hive_roof_status(self, request: operations.HiveRoofStatusRequest) -> operations.HiveRoofStatusResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='hiveRoofStatus', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.HiveRoofStatusResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
